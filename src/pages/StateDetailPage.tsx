		...
		<Box sx={{ py: 0, px: 0, width: "100%", margin: 0 }}>
			...
			<Paper sx={{ width: "100%", mb: 0 }}>
				<Box sx={{ borderBottom: 1, borderColor: "divider" }}>
					...
					>
						<Tab label={<Box sx={{ display: "flex", alignItems: "center", gap: 1 }}> <span>Overview</span> </Box>} />
						{isDetail && (
							<Tab label={<Box sx={{ display: "flex", alignItems: "center", gap: 1 }}> <span>Provisional Ballots</span> </Box>} />
						)}
						{isDetail && (
							<Tab label={<Box sx={{ display: "flex", alignItems: "center", gap: 1 }}> <span>Active Voters</span> </Box>} />
						)}
						{/* NEW tabs */}
						{isDetail && (
							<Tab label={<Box sx={{ display: "flex", alignItems: "center", gap: 1 }}> <span>Pollbook Deletions</span> </Box>} />
						)}
						{isDetail && (
							<Tab label={<Box sx={{ display: "flex", alignItems: "center", gap: 1 }}> <span>Mail Rejections</span> </Box>} />
						)}
						<Tab label={<Box sx={{ display: "flex", alignItems: "center", gap: 1 }}> <span>Voting Equipment</span> </Box>} />
						{isDetail && (
							<Tab label={<Box sx={{ display: "flex", alignItems: "center", gap: 1 }}> <span>Voter Registration Data</span> </Box>} />
						)}
					</Tabs>
				</Box>
