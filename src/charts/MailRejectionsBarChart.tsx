...
const LABELS: Record<keyof MailRejectionRow, string> = {
    ...
    dataYear: "Year",
    C9b_NoSignature: "No Signature",
    C9c_SigMismatch: "Signature Mismatch",
    C9d_ReceivedLate: "Received Late",
    C9e_MissingInfo: "Missing Info",
    C9f_NotRegistered: "Not Registered",
    C9g_WrongEnvelope: "Wrong Envelope",
    C9h_Other: "Other",
    total: "Total",
